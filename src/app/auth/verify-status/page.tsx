...
export default function VerifyStatusPage() {
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-150px)] px-4 py-12 bg-background text-foreground transition-colors duration-300">
      <Suspense fallback={
        <div className="w-full max-w-md p-8 space-y-6 bg-white shadow-lg rounded-lg text-center dark:bg-gray-800 dark:text-gray-100">
          <p className="text-lg">Loading verification status...</p>
        </div>
      }>
        <VerifyStatusContent />
      </Suspense>
